...
export default function Sidebar({ onCardClick }: any) {
    ...
    const appointments = [
        { startTime: '10:00 AM', endTime: '11:00 AM', patientName: 'John Doe', staffName: 'Dr. Smith' },
        { startTime: '11:00 AM', endTime: '12:00 PM', patientName: 'Jane Doe', staffName: 'John grey' },
                ...
                return (
                    <div className='tabContainer'>
                        {staff.map((staff, index) => {
                            ...
                            return (
                                <div key={index} className='cardContainer' onClick={() => {
                                    ...
                                    style={selected === staff.name ? { border: '3px solid blue' } : {}}
                ...
                return (
                    <div className='tabContainer'>
                        {patients.map((patient, index) => {
                            ...
                            return (
                                <div key={index} className='cardContainer' onClick={() => onCardClick(patient)}>
                                    <div className='header'>
                                        <h1> {patient.name} </h1>
                                    </div>
                                    <div className="body">
                ...
                return (
                    <div className='tabContainer'>
                        {appointments.map((appointment, index) => {
                            ...
                            return (
                                <div key={index} className='cardContainer' onClick={() => onCardClick(appointment)}>
                                    <div className='header'>
                                        <h1> {appointment.startTime}-{appointment.endTime} </h1>
                                    </div>
                                    <div className="body">
